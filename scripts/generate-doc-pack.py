...
def main() -> None:
    ...
    doc = Document()
    doc.add_heading("OMS Mule Portfolio - Consolidated Documentation", level=0)
    doc.add_paragraph(
        "This Word document consolidates key architecture, lifecycle, "
        "operations, testing, and scorecard documents for the OMS portfolio."
    )
    ...
    files = [
        ...
        ("Regression Test Results", docs_dir / "REGRESSION_TEST_RESULTS_DETAILED.md"),
